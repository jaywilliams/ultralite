...
<p>
The WEB2BB system comes with a comprehensive validation class that can be used to validate an array of values from most any source. eg: POST, GET, SESSION, COOKIE or other source.
</p>
<?php
$code='
<?php
